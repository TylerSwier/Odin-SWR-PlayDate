...
//Creating the Model Matrix Math required for
// Translate
// Rotate
// Scale
// M = T * R * S
...
Mat4MultVec3 :: proc(mat: Matrix4x4, vec: Vector3) -> Vector3 {
...
Mat4MultVec4 :: proc(mat: Matrix4x4, vec: Vector4) -> Vector4 {
...
MakeRotationMatrix :: proc(pitch, yaw, roll: f32) ->  Matrix4x4 {
    ...
    ca := math.cos_f32(alpha)
    sa := math.sin_f32(alpha)

    cb := math.cos_f32(beta)
    sb := math.sin_f32(beta)

    cg := math.cos_f32(gamma)
    sg := math.sin_f32(gamma)
